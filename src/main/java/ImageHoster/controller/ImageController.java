...
public class ImageController {
    ...
    @RequestMapping(value = "/editImage/{imageId}/{userId}")
    public String editImage(@PathVariable("imageId") Integer imageId, @PathVariable("userId") Integer userId, HttpSession session, Model model, String editError) {
        ...
        if (user.getId() != userId) {
            model.addAttribute("editImage","editError");
    ...
    @RequestMapping(value = "/deleteImage/{imageId}/{userId}", method = RequestMethod.DELETE)
    public String deleteImageSubmit(@PathVariable("imageId") Integer imageId, @PathVariable("userId") Integer userId, HttpSession session, Model model) {
        User user = (User) session.getAttribute("loggeduser");
        Image image = imageService.getImage(imageId);

        if (user.getId() != userId) {
            model.addAttribute("editImage","deleteError");
            return "redirect:/images/" + image.getId() + "/" + image.getTitle();
        }
